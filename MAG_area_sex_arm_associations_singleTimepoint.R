### Create script that calcluates MAG abundance associations
...
meta <- read.csv('PostSamMam/Data/AnthropometryDataPostSAMMAM.csv') %>% 
  ...
  unique() %>% 
  left_join(read.csv('/Users/stevenhartman/Library/CloudStorage/Box-Box/000Gordon/Projects/PostSamMam/Data/SID_MasterKey.csv')) %>% 
...
write.csv(supp_table, 'PostSamMam/MAG_Analysis/LinearMixedEffectsModels/230622_suppTable_abundance_siteEnrichment/MAG_area_sex_arm_associations_singleTimepoint.csv',
          row.names = F)
